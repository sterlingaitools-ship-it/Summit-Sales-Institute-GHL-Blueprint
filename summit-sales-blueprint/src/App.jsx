      ...
      {tab === "voice" && (
        <div style={W}><FadeIn>
          ...
          <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", flexWrap: "nowrap" }}>
            {PIPELINE.map((p,i) => (
              <div key={i} style={{ flex: "1 1 0", background: navyMid, padding: "26px 18px", textAlign: "center", border: "1px solid rgba(255,255,255,0.06)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
